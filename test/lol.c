...
NOINLINE UNUSED static void P_data(UNUSED struct tc *ctx, unsigned o0, unsigned o1, unsigned o2,
...
NOINLINE UNUSED static void P_pcrel(UNUSED struct tc *ctx, uint32_t dpc,
									UNUSED struct arch_pcrel_info info) {
	return P_data(ctx, info.reg, null_op, null_op, null_op, 1);
}
NOINLINE UNUSED static void P_thumb_it(UNUSED struct tc *ctx) {
	type = NOPPY;
}

NOINLINE UNUSED static void P_ret(UNUSED struct tc *ctx) {
	type = JUMPY;
}

NOINLINE UNUSED static void P_indirect_call(UNUSED struct tc *ctx) {
	type = JUMPY;
}

NOINLINE UNUSED static void P_branch(UNUSED struct tc *ctx, uint64_t dpc, int cc) {
	type = BAD;
}

NOINLINE UNUSED static void P_unidentified(UNUSED struct tc *ctx) {
	type = BAD;
}

NOINLINE UNUSED static void P_bad(UNUSED struct tc *ctx) {
	type = JUMPY;
}
