...
static kern_return_t manual_thread_get_state(
	...
	mach_msg_type_number_t *old_stateCnt, mach_port_t reply_port);
/* Routine thread_set_state */
static kern_return_t manual_thread_set_state(
	thread_act_t target_act,
	thread_state_flavor_t flavor,
	thread_state_t new_state,
	mach_msg_type_number_t new_stateCnt, mach_port_t reply_port);
...
#pragma pack()
	...
	__AfterSendRpc(3603, "thread_get_state") if (msg_result != MACH_MSG_SUCCESS) {
...
#pragma pack()
	...
	__AfterSendRpc(3604, "thread_set_state") if (msg_result != MACH_MSG_SUCCESS) {
		__MachMsgErrorWithoutTimeout(msg_result);
		{ return msg_result; }
	}
...
static kern_return_t manual_mach_vm_remap(
	...
	vm_inherit_t inheritance, mach_port_t reply_port);
#ifdef __MigPackStructs
#pragma pack(4)
#endif
typedef struct
...
#pragma pack()
	...
	__BeforeSendRpc(4813, "mach_vm_remap")
		msg_result = manual_mach_msg(&InP->Head, MACH_SEND_MSG | MACH_RCV_MSG | MACH_MSG_OPTION_NONE, (mach_msg_size_t)sizeof(Request), (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(4813, "mach_vm_remap") if (msg_result != MACH_MSG_SUCCESS) {
		__MachMsgErrorWithoutTimeout(msg_result);
		{ return msg_result; }
	}
