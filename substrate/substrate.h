...
MSImageRef MSGetImageByName(const char *file) __asm__("SubGetImageByName");
void *MSFindSymbol(MSImageRef image, const char *name) __asm__("SubFindSymbol");

void MSHookFunction(void *symbol, void *replace, void **result) __asm__("SubHookFunction");

#ifdef __APPLE__
void MSHookMessageEx(Class _class, SEL sel, IMP imp, IMP *result) __asm__("SubHookMessageEx");
#endif
